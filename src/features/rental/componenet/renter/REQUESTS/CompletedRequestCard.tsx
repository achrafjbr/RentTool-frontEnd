...
export default function CompletedRequestCard({ rental }: { rental: Rental }) {
    ...
    <div className="rounded-lg shadow hover:shadow-md p-5 border border-gray-100">
      <div className="grid grid-cols-12 gap-2.5 ">
        ...
        <div className="col-span-8 ">
          ...
          text-blue-600 bg-blue-400/10 border border-blue-200"
          >
            Fermé
          </p>
        ...
        <div className="col-span-3 flex flex-col justify-start gap-3.5 items-end">
          ...
          <div
            className="w-fit text-blue-600 bg-blue-400/10 border 
          border-blue-200 rounded-md p-0.5 px-2 flex items-center gap-2"
          >
            <CircleCheck size={18} className="text-blue-500" />
            <p className="text-xs font-semibold">Clôturé</p>
          </div>
        </div>
      </div>
    </div>
